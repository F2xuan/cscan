...
type IncrSubTaskDoneReq struct {
	...
	IncrAmount    int32                  `protobuf:"varint,6,opt,name=incrAmount,proto3" json:"incrAmount,omitempty"`   // 递增数量（=目标数，默认1）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IncrSubTaskDoneReq) GetIncrAmount() int32 {
	if x != nil {
		return x.IncrAmount
	}
	return 0
...
const file_task_proto_rawDesc = "" +
	...
	"\x05count\x18\x04 \x01(\x05R\x05count\"\xc6\x01\n" +
	...
	"\visCompleted\x18\x05 \x01(\bR\visCompleted\x12\x1e\n" +
	"\n" +
	"incrAmount\x18\x06 \x01(\x05R\n" +
	"incrAmount\"\xa9\x01\n" +
